...
/** Moves that are physically trivial: standing up, opening a thing, finding a thing. */
const TRIVIAL =
  /^(g[åa]|rejs|[åa]bn|find|tag|t[æa]nd|s[æa]t|log ind|hent|skriv .{0,18} ned|kig|tjek|l[æa]g|saml|beslut)\b/i

/** Moves that involve other people or a real chunk of work. */
const HEAVIER = /^(ring|send|udfyld|optag|rediger|post|betal|book|bestil|svar)\b/i
